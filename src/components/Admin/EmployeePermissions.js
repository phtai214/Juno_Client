    ...
    const fetchEmployeeData = async () => {
      try {
        const response = await axios.get(
          `http://localhost:3001/api/v1/user/${employeeId}`
        );
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="permissions-list">
          <div>
            ...
            />
            <label htmlFor="manageProducts">Quản lý sản phẩm</label>
          </div>
          ...
          <div>
            <input
              ...
              onChange={handlePermissionChange}
            />
            <label htmlFor="manageOrders">Quản lý đơn hàng</label>
          </div>
          ...
          <div>
            <input
              ...
              onChange={handlePermissionChange}
            />
            <label htmlFor="manageCustomers">Quản lý khách hàng</label>
          </div>
          ...
          <div>
            <input
              ...
              onChange={handlePermissionChange}
            />
            <label htmlFor="manageShops">Quản lý Shops</label>
          </div>
        </div>
