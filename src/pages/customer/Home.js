    ...
    <div className="home-container">
      <div className="Banner-homePage">
        ...
        >
          ...
          <SwiperSlide>
            <img
              src="https://res.cloudinary.com/dhjrrk4pg/image/upload/v1729629987/461804403_963256905844127_7265258711963620623_n_ylkyxe.jpg"
              alt="Image 2"
              style={{ width: "100%", height: "auto" }}
            />
          </SwiperSlide>
      ...
      <div className="FLASH-SALE">
        ...
        <div className="box-banner-small">
          <img
            ...
            src="https://res.cloudinary.com/dhjrrk4pg/image/upload/v1729631496/img_7150_aej5mr.jpg"
          />
          <img
            className="banner-small-image"
            src="https://res.cloudinary.com/dhjrrk4pg/image/upload/v1729631497/img_7152_xogmhl.png"
          />
          <img
            className="banner-small-image"
            src="https://res.cloudinary.com/dhjrrk4pg/image/upload/v1729631496/img_7151_swphdr.jpg"
          />
        </div>
        <SliderProduct />
        <div className="product-new">
          <h4 className="product-new-title">HÀNG MỚI VỀ</h4>
          <p className="product-new-note">
            ...
            {products.slice(0, 4).map((product, index) => (
              <div key={index} className="product-new-item col-md-4 col-sm-6">
                <Link to={`/customer/product/slug/${product.slug}`}>
                  <img
                    className="product-new-item-image"
          ...
          <div className="instagram-container row">
            <div className="col-md-3 col-sm-3 instagram-item">
              <img
                ...
                src="https://res.cloudinary.com/dhjrrk4pg/image/upload/v1731587391/instagram1_s0twgb.webp"
              />
            </div>
            <div className="col-md-3 col-sm-3 instagram-item">
              <img
                className="instagram-item-image"
                src="https://res.cloudinary.com/dhjrrk4pg/image/upload/v1731587391/instagram2_sstxra.jpg"
              />
            </div>
            <div className="col-md-3 col-sm-3 instagram-item">
              <img
                className="instagram-item-image"
                src="https://res.cloudinary.com/dhjrrk4pg/image/upload/v1731587391/instagram4_y0zi2l.webp"
              />
            </div>
            <div className="col-md-3 col-sm-3 instagram-item">
              <img
                className="instagram-item-image"
                src="https://res.cloudinary.com/dhjrrk4pg/image/upload/v1731587391/instagram3_kvfdfs.jpg"
              />
            </div>
          </div>
        </div>
