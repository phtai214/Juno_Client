...
function UsersPage() {
    ...
    const handleCreate = () => {
        navigate(`/admin/createUser`); // Navigate to UpdateUser page with userId
    };
    ...
    return (
        <div className="user-container">
            ...
            <div className="btn-box-create">
                <button onClick={handleCreate} className="create-user">Create User</button>
            ...
            <table className="table">
                ...
                <tbody>
                    {(searchQuery ? filteredData : data).map((user) => (
                        <tr key={user.id}> {/* Use user.id as key for uniqueness */}
                            <td>
                                <div className="user">
                                    {user.avatar ? (
